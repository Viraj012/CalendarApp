...
public class CommandProcessorTest {
  ...
  public void testCopyEventsBetweenWithStartDateAfterEndDate() {
    ...
    assertTrue("Command should return true to continue processing", result);
    assertNotNull("Error should be displayed when start date is after end date",
        textUI.getLastError());
  }
  ...
  public void testCopyEventsBetweenWithInvalidTargetCalendar() {
    ...
    assertTrue("Command should return true to continue processing", result);
    assertNotNull("Error should be displayed for non-existent target calendar",
        textUI.getLastError());
  }
  ...
  public void testCopyEventsBetweenWithLongDateRange() {
    ...
    assertTrue("Command should return true to continue processing", result);
    assertNotNull("Command should be processed without errors for long date range",
        textUI.getLastError());
  }
